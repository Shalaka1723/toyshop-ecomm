  ...
  return (
    ...
    <div className='flex relative w-screen  h-24 justify-between items-center shadow-lg bg-[#ffd231] text-[#208e95] px-7 py-9 '>
        ...
        {/* <ul className='flex space-x-10'>
            ...
            <li className=' transition-all hover:border-b-4 border-yellow-200 hover:text-pink-600'>Boys</li>
            <li className=' transition-all hover:border-b-4 border-yellow-200 hover:text-pink-600'>Kids Books</li>
        </ul> */}
